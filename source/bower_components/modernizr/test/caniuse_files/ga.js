(function () {
  var k = void 0, aa = encodeURIComponent, l = String, o = Math, ba = "push", ca = "cookie", p = "charAt", q = "indexOf", da = "getTime", r = "toString", t = "window", v = "length", w = "document", x = "split", y = "location", ea = "protocol", fa = "href", z = "substring", A = "join", C = "toLowerCase";
  var ga = "_gat", ha = "_gaq", ia = "4.9.4", ja = "_gaUserPrefs", ka = "ioo", D = "&", E = "=", F = "__utma=", H = "__utmb=", la = "__utmc=", ma = "__utmk=", I = "__utmv=", J = "__utmz=", na = "__utmx=", oa = "GASO=";
  var pa = function () {
    var d = this, f = [], b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_";
    d.set = function (b) {
      f[b] = !0
    };
    d.Sc = function () {
      for (var d = [], e = 0; e < f[v]; e++)f[e] && (d[o.floor(e / 6)] ^= 1 << e % 6);
      for (e = 0; e < d[v]; e++)d[e] = b[p](d[e] || 0);
      return d[A]("") + "~"
    }
  }, qa = new pa;
  ...
  var ra = function (d, f) {
    ...
    b.Jb = function (b) {
      return navigator.userAgent[q](b) >= 0
    };
    b.Xc = function () {
    ...
    b.qb =
        function (d) {
          ...
          for (var d = d.replace(/\n|\r/g, " "), e = 0, f = d[v]; e < f; ++e) {
            ...
            if (g == 10 || g == 13)d = d[z](0, e) + "?" + d[z](e + 1)
          }
          return d
        }
  ...
  var sa = function (d) {
    ...
    return Object.prototype[r].call(Object(d)) == "[object Array]"
  }, M = function (d) {
    return k == d || "-" == d || "" == d
  }, N = function (d, f, b) {
    var h = "-", e;
    !M(d) && !M(f) && !M(b) && (e = d[q](f), e > -1 && (b = d[q](b, e), b < 0 && (b = d[v]), h = d[z](e + f[q](E) + 1, b)));
    return h
  }, xa = function (d) {
    var f = !1, b = 0, h, e;
    if (!M(d)) {
      f = !0;
      for (h = 0; h < d[v]; h++)e = d[p](h), b += "." == e ? 1 : 0, f = f && b <= 1 && (0 == h && "-" == e || ".0123456789"[q](e) > -1)
    }
    return f
  }, P = function (d, f) {
    var b = aa;
    ...
    var b = decodeURIComponent, h, d = d[x]("+")[A](" ");
  ...
  var T = function (d, f) {
    ...
    return o.round(o.random() * 2147483647)
  }, Ba = function () {
  };
  var Ca = function (d, f) {
    this.ib = d;
    ...
    function d(b) {
      for (var d = [], b = b[x](","), e, f = 0; f < b[v]; f++)e = b[f][x](":"), d[ba](new Ca(e[0], e[1]));
      return d
    }
  ...
  var Ea = function (d) {
    ...
    function b(a, c) {
      return "^" + [[c, a[1]][A]("."), a[0]][A](":")
    }

    function h(a) {
      var c = new Date, a = new Date(c[da]() + a);
    ...
    e.l = function (a, c, b) {
      ...
      a += c;
      a = L.qb(a);
      a[v] > 2E3 && (K(69), a = a[z](0, 2E3));
      j = a + "; path=" + m.f + "; " + j + e.hb();
      if (!V.pb())L[w].cookie = j
    };
    e.Oc = function (a, c, d, j, i) {
      var g = "", i = i || m.s, j = b([j, e.m + i * 1], d), g = N(a, "2" + c, ";");
      if (!M(g))return a = b(f(a, c, d, !0), d), g = g[x](a)[A](""), g = j + g;
      return j
    };
    e.hb = function () {
      return M(m.b) ? "" : "domain=" +
  ...
  var Fa = function (d) {
    ...
    function b(a, c) {
      var n = [], b;
      if (!M(a) && (n = a[x]("."), c))for (b = 0; b < n[v]; b++)xa(n[b]) || (n[b] = "-");
      return n
    }
    ...
    var e, m, g, a, c, u, j, i = this, s, n = d;
    i.i = new Ea(d);
    i.Ba = function () {
      return k == s || s == i.K()
    };
    ...
    i.I = [[F, i.ba, i.Na, i.Qa, "."], [H, i.z, i.$, i.aa, ""], [la, i.ca, i.Oa, i.Ra, ""], [na, i.ea, i.Pa, i.Sa, ""], [J, i.qa, i.ra, i.sa, "."], [I, i.da, i.X, i.Y, "."]]
  };
  var Ga = "https:" == L[w][y][ea] ? "https://ssl.google-analytics.com/" : "http://www.google-analytics.com/", Ha = Ga + "p/__utm.gif", Ja = function () {
    var d = this;
    ...
    d.ed = function (d, b) {
      ...
      if (e)h =
          new e, h.open("POST", Ha); else if (e = L[t].XMLHttpRequest)e = new e, "withCredentials"in e && (h = e, h.open("POST", Ha, !0), h.setRequestHeader("Content-Type", "text/plain"));
    ...
    d.Ob = function (f, b) {
      ...
      if (h.body) {
        ...
        var g = h[y],
            g = g[ea] + "//" + g.host + "/favicon.ico", g = Ga + "u/post_iframe.html#" + aa(g), a = function () {
              e.src = "";
              e.parentNode && e.parentNode.removeChild(e)
            };
        ta(L[t], "beforeunload", a);
        var c = !1, u = 0, j = function () {
          if (!c) {
            try {
              if (u > 9 || e.contentWindow[y].host == h[y].host) {
                c = !0;
                a();
                var d = L[t], g = "beforeunload", n = a;
  ...
  var Ka = function (d) {
    var f = this, b = d, h = new Fa(b), e = null, m = !V.pb(), g = function () {
    };
    f.Uc = function () {
    ...
    f.A = function (a, c, d, j, i, s) {
      ...
      if (B[1] < 500 || j) {
        if (i) {
          var S = (new Date)[da](), X;
          X = (S - B[3]) * (b.Ac / 1E3);
          X >= 1 && (B[2] = o.min(o.floor(B[2] * 1 + X), b.zc), B[3] = S)
        }
        if (j || !i || B[2] >= 1) {
          !j && i && (B[2] = B[2] * 1 - 1);
          j = B[1] * 1 + 1;
  ...
  W.Qc = function (d, f, b, h, e, m) {
    ...
    g.Eb = m;
    g.ha = function () {
      return "&" + ["utmt=item", "tid=" + P(g.Fb), "ipc=" + P(g.va), "ipn=" + P(g.n), "iva=" + P(g.Cb), "ipr=" + P(g.Db), "iqt=" + P(g.Eb)][A]("&utm")
    }
  };
  W.Wc = function (d, f, b, h, e, m, g, a) {
    ...
    c.ha = function () {
      return "&" + ["utmt=tran", "id=" + P(c.q), "st=" + P(c.tb), "to=" + P(c.zb), "tx=" + P(c.yb), "sp=" + P(c.wb), "ci=" + P(c.ub), "rg=" + P(c.xb), "co=" + P(c.vb)][A]("&utmt")
    }
  };
  var La = function (d) {
    function f() {
      var b, a, c;
      a = "ShockwaveFlash";
      var d = "$version", j = L[t].navigator;
      if ((j = j ? j.plugins : k) && j[v] > 0)for (b = 0; b < j[v] && !c; b++)a = j[b], R(a.name, "Shockwave Flash") && (c = a.description[x]("Shockwave Flash ")[1]); else {
        a = a + "." + a;
        try {
    ...
    var b = this, h = "-", e = L[t].screen, m = L[t].navigator;
    b.Nb = e ? e.width + "x" + e.height : h;
    b.Mb = e ? e.colorDepth + "-bit" : h;
    b.cd = P(L[w].characterSet ? L[w].characterSet : L[w].charset ? L[w].charset : h);
    b.Lb = (m && m.language ? m.language : m && m.browserLanguage ? m.browserLanguage : h)[C]();
    b.Kb = m && m.javaEnabled() ? 1 : 0;
    b.dd = d ? f() : h;
    b.dc = function () {
      return D + "utm" + ["cs=" + P(b.cd), "sr=" + b.Nb, "sc=" + b.Mb, "ul=" + b.Lb, "je=" + b.Kb, "fl=" + P(b.dd)][A]("&utm")
    };
    b.cc = function () {
      for (var d = L[t].navigator, a = L[t].history[v],
               d = d.appName + d.version + b.Lb + d.platform + d.userAgent + b.Kb + b.Nb + b.Mb + (L[w][ca] ? L[w][ca] : "") + (L[w].referrer ? L[w].referrer : ""), c = d[v]; a > 0;)d += a-- ^ c++;
      return za(d)
    }
  };
  var Z = function (d, f, b, h) {
    ...
    g.nb = function (a) {
      ...
      var d = "";
      b = b[x]("://")[1][C]();
      R(b, "/") && (b = b[x]("/")[1], R(b, "?") && (d = b[x]("?")[0]));
      b = d;
      if (R(c, "google") && (a = a[x]("?")[A](D), R(a, D +
          m.xc + E) && b == m.wc))return !0;
      return !1
    };
    g.ua = function () {
      var a, c = g.ob, b, d = m.J;
      if (!M(c) && "0" != c && R(c, "://") && !g.nb(c)) {
        a = e(c);
        for (var i = 0; i < d[v]; i++)if (b = d[i], R(a, b.ib[C]()) && (c = c[x]("?")[A](D), R(c, D + b.jb + E)))return a = c[x](D + b.jb + E)[1], R(a, D) && (a = a[x](D)[0]), new Z.v(k, b.ib, k, "(organic)", "organic", a, k, k)
      }
    };
    g.R = function (a, c, b) {
      a = N(a, c + E, D);
    ...
    g.Bc = function (a) {
      var c = m.V, b = !1;
      if (a && "organic" == a.P)for (var a = Q(a.G)[C](), d = 0; d < c[v]; d++)b = b || c[d][C]() == a;
      return b
    };
    g.lb = function () {
      var a =
    ...
    g.kb = function (a) {
      var c = "";
      m.U && (c = a && a.hash ? a[fa][z](a[fa][q]("#")) : "", c = "" != c ? c + D : c);
      c += a.search;
      return c
    };
    g.ta = function () {
    ...
    g.te = function (a) {
      var a = N(a, J + g.a + ".", ";"), c = a[x]("."), a = new Z.v;
      a.gb(c.slice(4)[A]("."));
      if (!g.h(a))return !0;
      c = L[w][y];
      c = g.kb(c);
      ...
      return g.h(c) && a.H()[C]() != c.H()[C]()
    };
    g.Pb = function (a, c) {
      if (m.Ka) {
        var b = "", d = "-", e, f = 0, n, h, B = g.a;
        if (a) {
          h = a.g();
          b = g.kb(L[w][y]);
          ...
          g.h(e) || M(d) && c && (e = g.ta());
          if (g.h(e) && (M(d) || (f = d[x]("."), n = new Z.v, n.gb(f.slice(4)[A](".")), n = n.H()[C]() == e.H()[C](), f = f[3] * 1), !n || c))h = N(h, F + B + ".", ";"), n = h.lastIndexOf("."), h = n > 9 ? h[z](n + 1) * 1 : 0, f++, h = 0 == h ? 1 : h, a.ra([B, g.m, h, f, e.H()][A](".")), a.sa()
        }
      }
    }
  };
  Z.v = function (d, f, b, h, e, m, g, a) {
    ...
    c.xa = a;
    c.H = function () {
      var a = [], b = [["cid", c.q], ["csr", c.Q], ["gclid", c.ya], ["ccn", c.n], ["cmd", c.P], ["ctr", c.G], ["cct", c.Gb], ["dclid", c.xa]], d, e;
      if (c.fb())for (d = 0; d < b[v]; d++)M(b[d][1]) || (e = b[d][1][x]("+")[A]("%20"), e = e[x](" ")[A]("%20"), T(a, "utm" + b[d][0] + E + e));
      return L.qb(a[A]("|"))
    };
    c.fb = function () {
  ...
  var Ma = function (d, f, b, h) {
    ...
    e.$b = function () {
      ...
      if (!M(a)) {
        a = a[x]("|");
        var b = e.r, c = a[1], d;
        if (!M(c))for (var c = c[x](","), n = 0; n < c[v]; n++)d = c[n], M(d) || (d = d[x](g), d[v] == 4 && (b[d[0]] = [Q(d[1]), Q(d[2]), 1]));
        e.wa = Q(a[0]);
        e.T()
      }
    };
  ...
  var Na = function () {
    ...
    function h(a) {
      ...
      for (d = 0; d < u[v]; d++)if (e = a[u[d]], k != e) {
        ...
        for (var c = [], g = k, f = k, f = 0; f < e[v]; f++)if (k != e[f]) {
          ...
          var h;
          h = e[f];
          for (var O = "", m = k, U = k, wa = k, m = 0; m < h[v]; m++)U = h[p](m),
              wa = B[U], O += k != wa ? wa : U;
          h = O;
          g += h;
          T(c, g)
    ...
    var e = this, m = sa(e), g = {}, a = "k", c = "v", u = [a, c], j = "(", i = ")", s = "*", n = "!", O = "'", B = {};
    B[O] = "'0";
    B[i] = "'1";
    B[s] = "'2";
    B[n] = "'3";
    ...
    e.C = function () {
      var a = "", b;
      for (b in g)k != g[b] && (a += b[r]() + h(g[b]));
      return a
    };
    e.hc = function (a) {
      if (a == k)return e.C();
      var b = a.C(), c;
      for (c in g)k != g[c] && !a.Yc(c) && (b += c[r]() + h(g[c]));
      return b
    };
    ...
    e.ja = m("_setValue", 90, function (a, b, n) {
      if (typeof n != "number" && (k == Number || !(n instanceof Number)) || o.round(n) != n || n == NaN || n == Infinity)return !1;
      d(a, c, b, n[r]());
      return !0
    });
  ...
  var Pa = function (d, f) {
    var b = this, h = L.Gc(), e = L.Hc(), m = 10;
    b.rb = new Na;
    b.Kc = function () {
      var b, a = "timing", c = "onloadT";
  ...
  $.Zc = function (d) {
    var f = "gaso=", b = L[w][y].hash;
    d = b && 1 == b[q](f) ? N(b, f, D) : (b = L[t].name) && 0 <= b[q](f) ? N(b, f, D) : N(d.g(), oa, ";");
    return d
  };
  $.ad = function (d, f) {
    var b = (f || "www") + ".google.com", b = "https://" + b + "/analytics/reporting/overlay_js?gaso=" + d + D + Aa(), h = "_gasojs", e = L[w].createElement("script");
  ...
  $.load = function (d, f) {
    if (!$.$c) {
      var b = $.Zc(f), h = b && b.match(/^(?:\|([-0-9a-z.]{1,30})\|)?([-.\w]{10,1200})$/i);
  ...
  var Qa = function (d, f, b) {
    ...
    function e() {
      h();
      var a = j.b, b = a[q]("www.google.") * a[q](".google.") * a[q]("google.");
    ...
    function m(b, c, d) {
      ...
      b = N(b, F + a.a + ".", c);
      M(b) || (b = b[x]("."), b[5] = "" + (b[5] ? b[5] * 1 + 1 : 1), b[3] = b[4], b[4] = d, b = b[A]("."));
      return b
    }
    ...
    var a = this, c = sa(a), u = k, j = new Da, i = !1, s = k;
    a.n = d;
    a.m = o.round((new Date)[da]() /
    1E3);
    a.p = f || "UA-XXXXX-X";
    a.ab = L[w].referrer;
    a.oa = k;
    ...
    a.kc = function (a, b) {
      if (M(a))a = "-"; else {
        b += j.f && "/" != j.f ? j.f : "";
        var c = a[q](b), a = c >= 0 && c <= 8 ? "0" : "[" == a[p](0) && "]" == a[p](a[v] - 1) ? "-" : a
      }
      return a
    };
    a.na = function (b) {
      ...
      if (!d.hid)d.hid = Aa();
      d = d.hid;
      c += "&utmhid=" + d + "&utmr=" + P(l(a.oa)) + "&utmp=" + P(a.pc(b));
      return c
    };
    a.pc = function (a) {
      var b = L[w][y];
    ...
    a.cb = c("_getLinkerUrl", 52, function (b, c) {
      var d = b[x]("#"), e = b, f = a.jc();
      if (f)if (c && 1 >= d[v])e += "#" + f; else if (!c || 1 >= d[v])1 >= d[v] ? e += (R(b,
          "?") ? D : "?") + f : e = d[0] + (R(b, "?") ? D : "?") + f + "#" + d[1];
      return e
    });
    a.nc = function () {
      var b = a.m, c = a.k, d = c.g(), e = a.a + "", f = L.Ya(), g, h = R(d, F + e + "."), i = R(d, H + e), u = R(d, la + e), s, G = [], Y = "", Ia = !1, d = M(d) ? "" : d;
      if (j.w && !a.eb) {
        g = L[w][y] && L[w][y].hash ? L[w][y][fa][z](L[w][y][fa][q]("#")) : "";
        j.U && !M(g) && (Y = g + D);
        Y += L[w][y].search;
      ...
      M(s) ? h ? (s = !i || !u) ? (s = m(d,
          ";", l(b)), a.F = !0) : (s = N(d, F + e + ".", ";"), G = N(d, H + e, ";")[x](".")) : (s = [e, a.mc(), b, b, b, 1][A]("."), Ia = a.F = !0) : M(c.z()) || M(c.ca()) ? (s = m(Y, D, l(b)), a.F = !0) : (G = c.z()[x]("."), e = G[0]);
      s = s[x](".");
      L[t] && f && f.dh == e && !j.o && (s[4] = f.sid ? f.sid : s[4], Ia && (s[3] = f.sid ? f.sid : s[4], f.vid && (b = f.vid[x]("."), s[1] = b[0], s[2] = b[1])));
      c.Na(s[A]("."));
      G[0] = e;
      G[1] = G[1] ? G[1] : 0;
      G[2] = k != G[2] ? G[2] : j.Wb;
    ...
    a.c = c("_initData", 2, function () {
      ...
      if (!i) {
        ...
        a.k = new Fa(j);
        a.e = new Na;
        s = new Ma(j, l(a.a), a.k, a.e);
        a.oc()
      }
      if (g()) {
        if (!i)a.oa = a.kc(a.ab, L[w].domain), b = new Z(l(a.a), a.oa, a.m, j);
        a.nc(b);
        s.$b()
      }
    ...
    a.oe = c("_setVar", 22, function (b) {
      b && "" != b && e() && (a.c(), s.bc(b), a.D() &&
      u.A("&utmt=var", a.p, a.a))
    });
    ...
    a.le =
        c("_setTrackOutboundSubdomains", 81, Ba);
  ...
  var Ta = function () {
    ...
    d.push = function () {
      ...
      for (var b = arguments, d = 0, e = 0; e < b[v]; e++)try {
        if (typeof b[e] === "function")b[e](); else {
          var f = "", g = b[e][0], a = g.lastIndexOf(".");
          a > 0 && (f = g[z](0, a), g = g[z](a + 1));
  ...
  a:{
    var Va = L[t][ha], Wa = !1;
    if (Va && typeof Va[ba] == "function" && (Wa = ua(Va), !Wa))break a;
    L[t][ha] = Sa;
    Wa && Sa[ba].apply(Sa, Va)
  }
  ;
})();
