 ...
 * Build: http://modernizr.com/download/#-shiv-load-mq-cssclasses
 */
;
window.Modernizr = function (e, t, n) {
  ...
  var r = "2.8.3", i = {}, s = !0, o = t.documentElement, u = "modernizr", a = t.createElement(u), f = a.style, l, c = {}.toString, h = {}, p = {}, d = {}, v = [], m = v.slice, g, y = function (e, n, r, i) {
    ...
    var r;
    return y("@media " + t + " { #" + u + " { position: absolute; } }", function (t) {
  ...
  !T(w, "undefined") && !T(w.call, "undefined") ? E = function (e, t) {
    ...
    var r = m.call(arguments, 1), i = function () {
      if (this instanceof i) {
        var e = function () {
        };
        e.prototype = n.prototype;
        var s = new e, o = n.apply(s, r.concat(m.call(arguments)));
        return Object(o) === o ? o : s
      }
      return n.apply(t, r.concat(m.call(arguments)))
    };
    return i
  });
  for (var k in h)E(h, k) && (g = k.toLowerCase(), i[g] = h[k](), v.push((i[g] ? "" : "no-") + g));
  return i.addTest = function (e, t) {
    if (typeof e == "object")for (var r in e)E(e, r) && i.addTest(r, e[r]); else {
      e = e.toLowerCase();
      if (i[e] !== n)return i;
      t = typeof t == "function" ? t() : t, typeof s != "undefined" && s && (o.className += " " + (t ? "" : "no-") + e), i[e] = t
    }
    return i
  }, S(""), a = l = null, function (e, t) {
    function c(e, t) {
    ...
    e.html5 = y, g(t)
  }(this, t), i._version = r, i.mq = b, i.testStyles = y, o.className = o.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (s ? " js " + v.join(" ") : ""), i
